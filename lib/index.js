...
function apply(ctx, config) {
  ctx.tools.register(defineTool({
    ...
    parameters: {
      ...
      items: { type: "array", items: { type: "object", additionalProperties: false }, description: "Graded items [{name, score, max, comment}] (grade)." },
      ...
      topics: { type: "array", items: { type: "object", additionalProperties: false }, description: "Topics [{name, hours}] (studyplan)." },
