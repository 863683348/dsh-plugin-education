...
function apply(ctx, config) {
  ctx.tools.register(defineTool({
    ...
    parameters: {
      ...
      items: { type: "array", items: { type: "object" }, description: "Graded items [{name, score, max, comment}] (grade)." },
      ...
      topics: { type: "array", items: { type: "object" }, description: "Topics [{name, hours}] (studyplan)." },
